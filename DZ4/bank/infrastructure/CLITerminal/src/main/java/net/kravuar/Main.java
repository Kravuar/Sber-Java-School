...
public class Main {
    ...
    static {
        ...
        accountService = new StubbedAccountsService(db);

        balanceService = new StubbedBalanceService(accountService);

        pinValidator = new StubbedPinValidator(accountService);
    ...
    private static void handleViewDB() {
        ...
        System.out.println(((StubbedAccountsService) accountService).getDB());
    }
